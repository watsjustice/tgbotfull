...
const bot = new Telegraf('5695594281:AAHLeRNeAoLbp0zL3fIvsbVRxgB8Q3T1whg');
...
const stage = new Scenes.Stage([opt,ssstage,subpayment,paymentinfo,accesspayment,subStatus,remoteQuestions,infoAbout,AcceptTheSub,resendAction]);
